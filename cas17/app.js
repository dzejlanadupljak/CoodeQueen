...
broj>6    ?console.log("broj je veci") :console.log("nije veci")
//uslov  ako je uslov taacan            ako nije tacan uslov


const niz=[1,34,56]
let rezu=niz.reduce((acc, el)=>acc+el,0)
console.log(rezu


)

const niz2=["h","e","l","l","o"]
let spojeno=niz2.reduce((acc,el)=>acc+el,"")
console.log(spojeno)